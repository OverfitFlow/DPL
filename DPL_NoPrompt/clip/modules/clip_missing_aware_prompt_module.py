...
# 
    ...
    def infer(
        ...
        if self.hparams.config["test_only"]:
            self.model.eval()
            if self.hparams.config["loss_names"]["hatememes"] > 0:
                if self.hparams.config["use_pl"] in {11}:
                    self.hatememes_classifier_ma.eval()
                elif self.hparams.config["use_pl"] != -1:
            ...
            if self.hparams.config["loss_names"]["food101"] > 0:
                if self.hparams.config["use_pl"] in {11}:
                    self.food101_classifier_ma.eval()
                elif self.hparams.config["use_pl"] != -1:
            ...
            if self.hparams.config["loss_names"]["mmimdb"] > 0:
                if self.hparams.config["use_pl"] in {11}:
                    self.mmimdb_classifier_ma.eval()
                elif self.hparams.config["use_pl"] != -1:
